...
<?php
    ...
    <div class="menu" style="height:425px; background-color:#BDB6E2; margin:0; justify-content: center; text-align: center;">
       ...
       <p class="text"> identidade: <br> <input class="barra" type="text" name="identidade" placeholder="sua identidade" required ></p>
       ...
       <p class="text"> Curso: <br> <input class="barra" type="text" name="curso" placeholder="Digite seu Curso"></p>
